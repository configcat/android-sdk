...
## Preparation
1. Run tests
3. Increase the version in the `gradle.properties` and `src/main/java/com.configcat/Utils.java` file.
4. Commit & Push
## Publish
...
2. Make sure the new version is available on [Maven Central](https://central.sonatype.com/artifact/com.configcat/configcat-android-client).
