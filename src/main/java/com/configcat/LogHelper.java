...
final class LogHelper {
    ...
    private static String formatStringListComparisonValue(String[] comparisonValue, boolean isSensitive ){
        ...
        for (int index = 0; comparisonValues.size() > index; index++) {
            comparisonValues.set(index, comparisonValues.get(index).trim());
        }
        ...
        if(isSensitive){
            ...
            for (String listElement: subList) {
                formatListBuilder.append("'").append(listElement).append("', ");
            }
