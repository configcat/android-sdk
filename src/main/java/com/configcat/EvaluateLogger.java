...
public class EvaluateLogger {
    ...
    public void logNoMatch(String comparisonAttribute, String userValue, Comparator comparator, Object comparisonValue) {
        entries.add("Evaluating rule: [" + comparisonAttribute + ":" + userValue + "] [" + comparator.getName() + "] [" + comparisonValue.toString() + "] => no match");
    }

    public String logFormatError(String comparisonAttribute, String userValue, Comparator comparator, Object
            comparisonValue, Exception exception) {
